package me.alexnaupay.platziarchitecture.entities
...
class Coupon(couponJson: JsonObject?) : Serializable {
    ...
    override fun toString(): String {
        return "Coupon(id='$id', image_url='$image_url', title='$title', descriptionShort='$descriptionShort', category='$category', description='$description', offer='$offer', website='$website', endDate='$endDate', url='$url')"
    }
